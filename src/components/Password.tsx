     ...
     <div className='bg-[#0095da] w-full h-screen flex flex-col justify-center items-center relative'>
        ...
        <div className=' bg-white rounded-[10px] w-[460px] h-[430px] relative p-9'>
             ...
             <div className='flex justify-end '>
                <svg width="20px" height="20px" viewBox="0 0 1024 1024" class="icon" xmlns="http://www.w3.org/2000/svg"><path fill="#000000" d="M754.752 480H160a32 32 0 100 64h594.752L521.344 777.344a32 32 0 0045.312 45.312l288-288a32 32 0 000-45.312l-288-288a32 32 0 10-45.312 45.312L754.752 480z"/></svg>
                   </div>
                   <div>
