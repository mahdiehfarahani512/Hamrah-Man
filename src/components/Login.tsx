...
const Login = () => {
  ...
  return (
    <div className='bg-[#0095da] w-full h-screen flex flex-col justify-center items-center relative'>
        ...
        <div className=' bg-white rounded-[10px] w-[460px] h-[380px] relative p-9'>
             <img className='absolute -top-20 right-[150px] w-[160px]' src={logo1} alt="" />

      <div className=' flex items-center gap-1 justify-end'>
           
        <span className='text-[#0b0b0d] text-[16px] font-semibold'>{t("log in")}</span>
         <span className='text-gray-400  '>|</span>
<span className='text-[#0b0b0d] text-[16px] font-semibold'>{t("sign up")}</span>
...
<div className=' flex '>
    ...
    <span className='text-gray-600'>|</span>
      ...
      <button className='text-white bg-[#0095da] py-7 w-full h-7 flex items-center justify-center rounded-[8px] mt-13 hover:opacity-80 cursor-pointer transition-all ' >{t("Confirm & Get Code")}</button>
 <div className='flex gap-2 mt-4 items-center justify-center'>
    <p className='text-[14px] text-[#1f2937] '> {t("Login with Password")}</p>
   
<svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 width="20px" height="20px" viewBox="0 0 70 70" enable-background="new 0 0 70 70" xml:space="preserve">
<g>
